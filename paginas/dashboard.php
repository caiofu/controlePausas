                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-6" style="margin-bottom: 7px;">
                                                    ...
                                                    @$RegistroPausa->select("*","idUsuario={$_SESSION['idUsuario']} AND horarioTermino = 0 ORDER BY idRegistroPausas DESC LIMIT 1 ");
                                                    @$RegistroPausa->contaRegistros("idUsuario={$_SESSION['idUsuario']}  AND horarioTermino = 0 ORDER BY idRegistroPausas DESC LIMIT 1");
                            ...
                            <div class="card shadow mb-4">
                                <div
                                    ...
                                    <?php
                                      ...
                                      $CarregaRegistros->contaRegistros("dataRegistro='{$dataAtual}' AND idUsuario = {$_SESSION['idUsuario']}");
                                      ?>
                                ...
                                <!-- Card Body -->
                                            ...
                                            <?php
                                                ...
                                                $CarregaRegistros->select("*","dataRegistro='{$dataAtual}' AND idUsuario = {$_SESSION['idUsuario']} AND horarioTermino > 0","idRegistroPausas DESC");
